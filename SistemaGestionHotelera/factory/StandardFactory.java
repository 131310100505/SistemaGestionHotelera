...
/** Patron FACTORY METHOD - Fabrica concreta de habitaciones Standard. */
public class StandardFactory extends HabitacionFactory {

    private static final double PRECIO_BASE = 20000.0;

    @Override
    public Habitacion crearHabitacion(int numero) {
        return new Habitacion(numero, TipoHabitacion.STANDARD, PRECIO_BASE);
    }
}
